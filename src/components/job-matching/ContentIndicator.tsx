...
const ContentIndicator = ({ 
  ...
  return (
    <div 
      className={`absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-background to-transparent flex items-end pb-2 cursor-pointer transition-opacity z-10 ${className}`}
      onClick={onClick}
