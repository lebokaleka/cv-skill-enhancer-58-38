...
interface ProfessionalBurgundyTemplateProps {
  content?: string;
  userData?: {
    name: string;
    address: {
...
const ProfessionalBurgundyTemplate: React.FC<ProfessionalBurgundyTemplateProps> = ({
  content = '',
  userData = {
    name: 'Floria Wayne',
    address: {
  ...
  return (
    <div className="bg-white text-black rounded-md shadow-md overflow-hidden border border-slate-200 relative">
      {/* Top and bottom triangle decorations */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        {/* Top left triangle */}
        <div 
          className="absolute top-0 left-0 w-0 h-0 border-solid" 
          style={{
            borderWidth: '4rem 4rem 0 0',
            borderColor: '#8B2942 transparent transparent transparent'
          }}
        />
        ...
        <div 
          ...
          style={{
            ...
            borderColor: 'transparent #8B2942 transparent transparent'
          }}
        />
        ...
        <div 
          ...
          style={{
            borderWidth: '4rem 0 0 4rem',
            borderColor: 'transparent transparent transparent #8B2942'
          }}
        />
        ...
        <div 
          ...
          style={{
            ...
            borderColor: 'transparent transparent #8B2942 transparent'
          }}
        />
      </div>
      ...
      <div className="p-8 pt-16 pb-16">
        ...
        <div className="flex justify-between mb-10">
          ...
          <div className="relative w-24 h-24 overflow-hidden">
            <div className="absolute inset-0 rounded-full border-4 border-[#8B2942]">
...
export default ProfessionalBurgundyTemplate;
